...
export const SocialLinks = ({ isSidebar }: { isSidebar?: boolean }) => {
	...
	return (
		<>
			<div
				className={`col-span-1 flex flex-row flex-wrap gap-1 text-neutral-600 dark:text-neutral-300 md:flex-nowrap ${
					...
					<>
						{publication.links?.twitter && (
							<a
								...
								className="flex flex-row items-center justify-center rounded-full border border-neutral-200 p-2 hover:bg-neutral-100 dark:border-neutral-800 dark:hover:bg-neutral-600"
							>
