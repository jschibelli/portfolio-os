...
export const ecommerceShopifyChatbot: ProjectMeta = {
  id: 'ecommerce-shopify-chatbot',
  title: 'E-commerce Shopify Chatbot Integration',
  slug: 'ecommerce-shopify-chatbot',
  ...
  endDate: '2024-05-15',
  technologies: ['Node.js', 'Express', 'OpenAI API', 'Shopify API', 'WebSocket', 'React', 'TypeScript'],
  category: 'web-app',
