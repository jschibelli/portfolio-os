  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 bg-white hover:bg-gray-50 text-gray-900 p-3 md:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 border border-gray-200"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed inset-4 md:bottom-24 md:right-6 md:left-auto md:top-auto z-40 w-auto md:w-96 h-auto md:h-[500px] max-h-[calc(100vh-2rem)] md:max-h-[500px] bg-white rounded-lg shadow-2xl border border-gray-200 flex flex-col">
                     {/* Header */}
           <div className="bg-gray-900 text-white p-3 md:p-4 rounded-t-lg flex items-center justify-between">
             <div className="flex items-center space-x-2 md:space-x-3">
               <div className="bg-white text-gray-900 p-1.5 md:p-2 rounded-full">
                 <Bot className="h-3 w-3 md:h-4 md:w-4" />
               </div>
               <div>
                 <h3 className="font-semibold text-sm md:text-base">John&apos;s Assistant</h3>
                 <p className="text-xs text-gray-300 hidden sm:block">Ask me about John&apos;s background</p>
               </div>
             </div>
          ...
          <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 md:space-y-4">
              ...
              >
                ...
                >
                  <div className="flex items-start space-x-1.5 md:space-x-2">
                    {message.sender === 'bot' && (
                      <Bot className="h-3 w-3 md:h-4 md:w-4 mt-0.5 text-gray-500 flex-shrink-0" />
                    )}
                    ...
                    {message.sender === 'user' && (
                      <User className="h-3 w-3 md:h-4 md:w-4 mt-0.5 text-gray-300 flex-shrink-0" />
                    )}
                  </div>
                </div>
              </div>
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-gray-100 text-gray-900 rounded-lg px-3 py-2 md:px-4 md:py-2">
                  <div className="flex items-center space-x-1.5 md:space-x-2">
                    <Bot className="h-3 w-3 md:h-4 md:w-4 text-gray-500" />
           ...
           <div className="p-3 md:p-4 border-t border-gray-200">
             <div className="flex space-x-2">
               <input
                 ...
                 className="flex-1 px-3 py-2 text-sm md:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent"
               ...
               <button
                 ...
                 className="bg-gray-900 hover:bg-gray-800 disabled:bg-gray-300 text-white p-2 rounded-lg transition-colors disabled:cursor-not-allowed flex-shrink-0"
