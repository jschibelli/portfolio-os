      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <Badge variant="secondary" className="bg-stone-200 dark:bg-stone-800 text-stone-700 dark:text-stone-300">
              Featured
            </Badge>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative group">
            <div className="relative overflow-hidden rounded-lg">
              ...
              <Badge 
                variant="secondary" 
                className="absolute top-4 left-4 bg-white/90 dark:bg-stone-800/90 text-stone-700 dark:text-stone-300"
              >
                Featured
              </Badge>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {tags.map((tag, index) => (
                <Badge 
                  key={index} 
                  variant="outline" 
                  className="border-stone-300 dark:border-stone-600 text-stone-700 dark:text-stone-300"
                >
                  {tag}
                </Badge>
              ))}
