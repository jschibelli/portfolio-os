...
export default function CaseStudyCard({ item, index }: CaseStudyCardProps) {
  console.log('Rendering CaseStudyCard for:', item.title);
  console.log('caseStudyUrl:', item.caseStudyUrl);
      ...
      <Card className="h-full max-h-[600px] overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:scale-[1.02] border-border/50 bg-gradient-to-br from-background to-muted/20 backdrop-blur-sm relative pointer-events-auto flex flex-col">
        <div className="relative overflow-hidden">
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="aspect-video relative overflow-hidden bg-gradient-to-br from-primary/10 to-primary/5"
          >
