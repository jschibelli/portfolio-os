			...
			<Head>
				<title>
					{publication.displayTitle ||
						publication.title ||
						'John Schibelli - Senior Front-End Developer'}
				</title>
				<meta
					name="description"
					content={
						publication.descriptionSEO ||
						'Senior Front-End Developer with 15+ years of experience building scalable, high-performance web apps and company websites. Skilled in React, Next.js, TypeScript, and Tailwind CSS with a strong focus on accessibility, SEO, and client success.'
					}
				/>
				...
				<meta
					...
					content={
						publication.descriptionSEO ||
						'Senior Front-End Developer with 15+ years of experience building scalable, high-performance web apps and company websites. Skilled in React, Next.js, TypeScript, and Tailwind CSS.'
					}
				/>
