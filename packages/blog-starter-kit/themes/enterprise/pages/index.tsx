...
export default function Home({ publication, recentPosts }: Props) {
	...
	const siteDescription = publication.descriptionSEO || 'Senior Front-End Developer with 15+ years of experience building scalable, high-performance web applications. Expert in React, Next.js, TypeScript, and modern development practices.';
