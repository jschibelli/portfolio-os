...
export default function RoseThemeDemo() {
  return (
    <>
      <Head>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="name" placeholder="Enter your name" style={{ 
                      '--ring': '346.8 77.2% 49.8%',
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" placeholder="Enter your message" style={{ 
                    '--ring': '346.8 77.2% 49.8%',
                    borderColor: roseColors.border
                  } as React.CSSProperties} />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <RadioGroup defaultValue="medium">
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="low" id="low" style={{ 
                          borderColor: roseColors.primary,
                          color: roseColors.primary
                        }} />
                      ...
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="medium" id="medium" style={{ 
                          borderColor: roseColors.primary,
                          color: roseColors.primary
                        }} />
                      ...
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="high" id="high" style={{ 
                          borderColor: roseColors.primary,
                          color: roseColors.primary
                        }} />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="notifications" style={{ 
                    borderColor: roseColors.primary,
                    color: roseColors.primary
                  }} />
                ...
                <Tabs defaultValue="overview" className="w-full">
                  ...
                  <TabsContent value="overview" className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Welcome to Mindware, your trusted partner in digital innovation and web development.
                    </p>
                  </TabsContent>
                  ...
                  <TabsContent value="reports" className="space-y-4">
                    <Alert>
                      <Calendar className="h-4 w-4" style={{ color: roseColors.primary }} />
                      <AlertDescription>
                        Monthly report will be available on the first of next month.
                      </AlertDescription>
                    </Alert>
                  </TabsContent>
                </Tabs>
