module.exports = {
	...
	rules: {
		...
		'react/jsx-closing-bracket-location': 'error', // Enforce consistent bracket location
		'react/jsx-closing-tag-location': 'error', // Enforce consistent tag location
		'react/jsx-curly-spacing': ['error', 'never'], // Enforce consistent spacing in curly braces
		'react/jsx-equals-spacing': ['error', 'never'], // Enforce consistent spacing around equals
		'react/jsx-first-prop-new-line': ['error', 'multiline'], // Enforce first prop on new line for multiline JSX
		'react/jsx-indent': ['error', 'tab'], // Enforce consistent indentation
		'react/jsx-indent-props': ['error', 'tab'], // Enforce consistent prop indentation
		...
		'react/jsx-props-no-multi-spaces': 'error', // Prevent multiple spaces in props
		...
		'react/jsx-tag-spacing': ['error', { closingSlash: 'never', beforeSelfClosing: 'always', afterOpening: 'never' }], // Enforce consistent tag spacing
		'react/jsx-uses-react': 'off', // Not needed in React 17+
		'react/jsx-uses-vars': 'error', // Prevent unused variables in JSX
		'react/jsx-wrap-multilines': ['error', { declaration: 'parens-new-line', assignment: 'parens-new-line', return: 'parens-new-line', arrow: 'parens-new-line', condition: 'parens-new-line', logical: 'parens-new-line', prop: 'parens-new-line' }], // Enforce consistent multiline wrapping
	},
};
