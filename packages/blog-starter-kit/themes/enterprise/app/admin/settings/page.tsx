        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-stone-200 dark:border-stone-700 rounded-md bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 focus:ring-2 focus:ring-stone-500 focus:border-transparent"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2">
    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-stone-800 rounded-lg shadow-sm border border-stone-200 dark:border-stone-700 p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="px-4 py-2 bg-stone-600 text-white rounded-md hover:bg-stone-700 transition-colors">
            Invite User
          </button>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-stone-200 dark:divide-stone-700">
            ...
            <tbody className="bg-white dark:bg-stone-800 divide-y divide-stone-200 dark:divide-stone-700">
              {users.map((user) => (
                <tr key={user.id} className="hover:bg-stone-50 dark:hover:bg-stone-700/50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <select
                      ...
                      className="px-3 py-1 text-sm border border-stone-200 dark:border-stone-700 rounded-md bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100"
                    >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 border border-stone-200 dark:border-stone-700 rounded-md bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 focus:ring-2 focus:ring-stone-500 focus:border-transparent font-mono text-sm"
            />
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-10 border border-stone-200 dark:border-stone-700 rounded-md bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 focus:ring-2 focus:ring-stone-500 focus:border-transparent"
              />
              <button
                type="button"
        ...
        <div className="space-y-4">
          <div className="p-4 border border-stone-200 dark:border-stone-700 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium text-stone-900 dark:text-stone-100">Google Analytics</h4>
                <p className="text-sm text-stone-600 dark:text-stone-400">Track website analytics and user behavior</p>
              </div>
              <button className="px-4 py-2 bg-stone-600 text-white rounded-md hover:bg-stone-700 transition-colors">
                Configure
              </button>
          ...
          <div className="p-4 border border-stone-200 dark:border-stone-700 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium text-stone-900 dark:text-stone-100">Newsletter Service</h4>
                <p className="text-sm text-stone-600 dark:text-stone-400">Manage email subscriptions and campaigns</p>
              </div>
              <button className="px-4 py-2 bg-stone-600 text-white rounded-md hover:bg-stone-700 transition-colors">
                Configure
              </button>
          ...
          <div className="p-4 border border-stone-200 dark:border-stone-700 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium text-stone-900 dark:text-stone-100">Social Media</h4>
                <p className="text-sm text-stone-600 dark:text-stone-400">Connect social media accounts for sharing</p>
              </div>
              <button className="px-4 py-2 bg-stone-600 text-white rounded-md hover:bg-stone-700 transition-colors">
                Configure
              </button>
              ...
              return (
                <button
                  ...
                  className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
                    activeTab === tab.id
                      ? 'border-stone-500 text-stone-900 dark:text-stone-100'
