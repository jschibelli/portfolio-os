...
<Note>
Looking for a quick reference? Jump to [Monorepo Structure](/docs/developer-guide/monorepo) for a deep dive into workspace tooling, or stay here for the high-level architecture context.
</Note>
