...
description: Step-by-step release workflow and process
lastUpdated: November 14, 2025
---
## Overview

Step-by-step release workflow and process
...
**What happens automatically:**
- ✅ Dashboard â†’ v1.0.0
- ✅ Root â†’ bumps to 2.0.0 (COMPLETE PLATFORM!)
