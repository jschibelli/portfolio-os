---
title: Release Guide
description: Guide for creating and managing releases
---
# Release Guide
...
1. âœ… Uses **semantic versioning** (SemVer)
2. âœ… Automates release creation via GitHub Actions
3. âœ… Extracts release notes from CHANGELOG.md
4. âœ… Supports pre-releases (alpha, beta, RC)
5. âœ… Generates release notes automatically
...
- ðŸ§ª Test new features before stable release
- ðŸ“Š Gather feedback from early users
- ðŸ› Catch bugs before production
- ðŸŽ¯ Staged rollout for risk mitigation
...
## âš™ï¸ Automated Release Workflow

### How It Works

The GitHub Action (`.github/workflows/release.yml`) automatically:

1. âœ… Detects when a version tag is pushed
2. âœ… Extracts version number and determines type
3. âœ… Reads release notes from CHANGELOG.md
4. âœ… Creates GitHub release with appropriate title
5. âœ… Marks as pre-release if applicable
6. âœ… Generates additional release notes from commits
...
- ðŸš€ Stable: `Portfolio OS v1.0.0`
- ðŸ”¬ Alpha: `Portfolio OS v1.0.0-alpha.1 (Alpha)`
- ðŸ§ª Beta: `Portfolio OS v1.0.0-beta.1 (Beta)`
- ðŸŽ¯ RC: `Portfolio OS v1.0.0-rc.1 (Release Candidate)`
