...
description: >-
  Code quality standards, testing strategy, CI/CD pipeline, and development
  workflows
---
## Overview
...
<Note type="note" title="Need Regression Details?">
  This page summarizes the philosophy. For the full automated regression playbook—including Jest, Playwright, and release gates—see the [Testing & Regression Strategy](/docs/features/testing).
</Note>
