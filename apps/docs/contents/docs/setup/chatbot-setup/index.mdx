...
This project includes an OpenAI-powered chatbot that uses John Schibelli's resume data as its knowledge base. The chatbot is powered by OpenAI's GPT-3.5-turbo model and provides conversational access to John Schibelli's professional background.

## Features

- 🤖 OpenAI-powered responses using GPT-3.5-turbo
- 📊 Knowledge base derived from John Schibelli's resume data
...
2. Type your question about John Schibelli's background, skills, or experience
