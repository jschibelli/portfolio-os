...
| Script | Purpose | Usage |
|--------|---------|-------|
| `pr-automation-unified.ps1` | AI-powered PR automation | `.\scripts\automation\pr-automation-unified.ps1 -PRNumber 123 -Action all` |
| `auto-configure-pr.ps1` | Configure PR fields/metadata | `.\scripts\automation\auto-configure-pr.ps1 -PRNumber 123` |
| `assign-pr-agents.ps1` | Assign PRs to agents | `.\scripts\automation\assign-pr-agents.ps1 -PRNumber 123` |
| `pr-quality-checker.ps1` | Check PR quality (legacy) | `.\scripts\pr-management\pr-quality-checker.ps1 -PRNumber 123` |
| `pr-monitor.ps1` | Monitor PR status (legacy) | `.\scripts\pr-management\pr-monitor.ps1` |
