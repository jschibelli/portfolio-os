...
description: PowerShell scripts for automation
---
...
**Features**:
- Continuous issue processing from Backlog â†’ In progress â†’ In review â†’ Ready â†’ Ready for Merge â†’ Done â†’ Merged
