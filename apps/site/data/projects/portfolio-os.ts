...
export const portfolioOS: ProjectMeta = {
	...
	slug: 'portfolio-os',
	description:
		'A monorepo portfolio that doubles as a development platform, combining enterprise automation with AI-assisted workflows to speed up development and maintain code quality.',
	...
	overview:
		'A monorepo portfolio that doubles as a development platform, combining enterprise automation with AI-assisted workflows to speed up development and maintain code quality.',
	challenge:
		'Managing a growing portfolio codebase while maintaining quality became time-consuming. Manual PR reviews, repetitive testing, and documentation drift slowed progress. The goal was to automate the mundane without losing control.',
	solution:
		'Built a comprehensive automation layer using PowerShell scripts, GitHub Actions, and AI agents. The system handles routine tasks like PR creation, testing, and documentation, while keeping humans in the decision loop.',
	keyFeatures: [
	...
	impact:
		'Development velocity increased significantly. PRs are created and managed automatically, tests catch issues before deployment, and documentation stays in sync with code. The portfolio itself demonstrates the engineering practices clients can expect.',
	version: '1.1.0',
