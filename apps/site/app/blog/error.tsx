...
/**
 * Error boundary for the blog list page
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-2">
              {isNetworkError ? "Connection Error" : "Unable to Load Blog Posts"}
            </h2>
            <p className="text-stone-600 dark:text-stone-400 mb-6">
              {isNetworkError
                ? "We're having trouble connecting to our blog service. Please check your internet connection and try again."
                : "We encountered an error while loading the blog posts. This issue has been logged and we'll look into it."}
            </p>
