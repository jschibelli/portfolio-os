...
export default async function BlogPage({
	...
	const pagedPosts =
		posts.length > listStartIndex ? posts.slice(listStartIndex, listStartIndex + listCount) : [];
				...
				{posts.length > 0 && (
					...
					>
						<ModernHero
							...
							description="Notes on software engineering, production systems, automation, and AI-assisted development."
					...
					{posts.length === 0 && (
						...
						>
							<div className="col-span-1 flex flex-col items-center gap-5 text-center text-stone-700 lg:col-start-2 dark:text-stone-400">
								...
								<p className={`animate-fade-in-up animation-delay-200 ${typeRole.heroSupport}`}>
					...
					{posts.length > 0 && featuredPost && (
						...
						>
							...
							{pagedPosts.length > 0 && (
								...
								>
									<h2
										className={`animate-fade-in-up text-stone-900 dark:text-stone-100 ${typeRole.sectionH2}`}
									>
										Latest Posts
									</h2>
