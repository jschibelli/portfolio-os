...
// Stats configuration for hero section
const stats = [
...
// Experience entries for career timeline
const experience = [
  {
    ...
    description: 'Designed and developed company website and architected AI-powered collaboration platform.',
    achievements: [
  ...
  },
  {
    ...
    location: 'Montville, NJ',
    description: 'Developed WordPress website and integrated booking system for car service business.',
    achievements: [
  ...
  },
  {
    ...
    description: 'Developed enterprise UIs and led WordPress projects while mentoring junior developers.',
    achievements: [
  ...
  },
  {
    ...
    achievements: [
      ...
      'Customized WordPress themes and plugins to support marketing functionality, content workflows, and SEO readiness.',
      'Collaborated directly with clients to scope requirements, translate designs into working UIs, and manage delivery timelines.',
    ],
    logo: '/assets/personal-logo.png',
  },
  {
    ...
    achievements: [
      ...
      'Oversaw accreditation compliance and partnered with organizations like Pearson VUE to establish certification opportunities.',
    ],
    logo: '/assets/personal-logo.png',
  },
];

// Value propositions for the "Why Choose Me" section
const valuePropositions = [
  {
    icon: CheckCircle,
    title: 'Project Delivery',
    metric: 'Multiple Projects',
    copy: 'Delivered web applications and digital solutions across various industries, working with teams to build e-commerce platforms and AI-driven collaboration tools.',
  },
  {
    icon: Users,
    title: 'Client Success',
    metric: 'Strong Relationships',
    copy: 'Maintained strong client relationships through reliable service delivery, clear communication, and meeting project goals consistently.',
  },
  {
    icon: Clock,
    title: 'Response Time',
    metric: '24h Response',
    copy: 'Focused on clear communication and timely responses. I prioritize your project needs and aim to respond within 24 hours to keep projects moving forward.',
  },
  {
    icon: Zap,
    title: 'AI-Enhanced Development',
    metric: 'Future-Ready',
    copy: 'Working with modern AI tools and development practices to build intelligent, scalable solutions that grow with your business needs.',
  },
  {
    icon: TrendingUp,
    title: 'Accessibility & SEO',
    metric: 'WCAG Compliant',
    copy: 'Building inclusive, accessible web experiences that reach all users while optimizing for search engines to maximize your digital presence.',
  },
  {
    icon: Star,
    title: 'Process Excellence',
    metric: 'Extensive Experience',
    copy: 'Refined development processes through years of experience, ensuring consistent quality, on-time delivery, and seamless project execution.',
  },
];
...
const targetAudiences = [
  {
    icon: Users,
    title: 'Recruiters',
    description: 'Open to new opportunities and exciting roles in front-end development and technical leadership',
    status: 'Available Now • Remote OK',
  },
  {
    icon: Star,
    title: 'Startup Founders',
    description: 'MVP development, technical consulting, and scaling your product from idea to market',
    status: 'Fast Turnaround • Proven Results',
  },
  {
    icon: Building,
    title: 'Enterprise',
    description: 'Technical consulting, architecture design, and enterprise-scale application development',
    status: 'Enterprise Ready • Scalable Solutions',
  },
  {
    icon: Code,
    title: 'Developers',
    description: 'Collaboration opportunities, knowledge sharing, and contributing to the developer community',
    status: 'Open Source • Mentoring',
  },
];
            ...
            >
              <div className="mb-16 text-center">
                ...
                <p className="text-lg text-stone-600 dark:text-stone-400 max-w-3xl mx-auto">
                  Results-focused development that supports business growth through collaborative web development and client partnerships
                </p>
              </div>

              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                {valuePropositions.map(({ icon: Icon, title, metric, copy }, i) => (
                  <motion.div 
                    key={title} 
                    initial={{ opacity: 0, y: 30 }} 
                    whileInView={{ opacity: 1, y: 0 }} 
                    ...
                    viewport={{ once: true }} 
                    className="group relative overflow-hidden rounded-2xl border border-stone-200 bg-white p-8 shadow-lg dark:border-stone-700 dark:bg-stone-900"
                  >
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                {targetAudiences.map((audience, i) => (
                  <motion.div 
                    ...
                    initial={{ opacity: 0, y: 20 }} 
                    whileInView={{ opacity: 1, y: 0 }} 
                    transition={{ duration: 0.6, delay: (i + 1) * 0.1, ease: 'easeOut' }} 
                    viewport={{ once: true }} 
                    className="group rounded-xl border-2 border-stone-200 bg-gradient-to-br from-stone-50 to-stone-100/50 p-6 text-center transition-all duration-300 hover:border-stone-300 hover:shadow-lg dark:border-stone-700 dark:from-stone-800/30 dark:to-stone-700/20"
                  >
                    ...
                    <h4 className="mb-3 text-lg font-bold text-stone-900 dark:text-stone-100">{audience.title}</h4>
                    <p className="mb-4 text-sm text-stone-700 dark:text-stone-300 leading-relaxed">{audience.description}</p>
                    <div className="text-xs text-stone-600 dark:text-stone-400 font-medium">{audience.status}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
