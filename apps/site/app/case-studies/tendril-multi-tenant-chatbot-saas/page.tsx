...
const caseStudyData = {
	...
	solution:
		'Built a comprehensive SaaS platform with tenant isolation, real-time messaging, and AI-powered chatbot capabilities',
...
const PainPointsChart = () => (
	...
	>
		<Card>
			<CardHeader>
				<CardTitle as="h3" className={`flex items-center gap-2 ${typeRole.cardTitle}`}>
	...
	>
		<Card>
			<CardHeader>
				...
				<CardDescription>Current chatbot solution market segmentation</CardDescription>
			</CardHeader>
			<CardContent>
					...
					<div className="flex items-center justify-center">
						<div className="relative h-48 w-48">
							<svg viewBox="0 0 100 100" className="h-full w-full">
								{marketShareData.map((item, index) => {
									const startAngle = marketShareData
										.slice(0, index)
	...
	>
		<Card>
			<CardHeader>
				...
				<CardDescription>User growth and revenue progression over 6 months</CardDescription>
			</CardHeader>
			<CardContent>
...
const TestimonialsSection = () => (
	<motion.section
		...
		className="my-12"
	>
		<h2 className={`mb-8 text-center ${typeRole.sectionH2}`}>What Our Customers Say</h2>
					...
					<Container className="py-8">
						...
						>
							...
							<motion.div variants={itemVariants} className="mb-12">
								<div
									className={`text-muted-foreground mb-4 flex items-center gap-2 ${typeRole.metadata}`}
								>
								...
								<h1 className={`mb-6 ${typeRole.caseStudyH1}`}>{caseStudyData.title}</h1>

								<p className={`text-muted-foreground mb-8 ${typeRole.heroSupport}`}>
								...
								{/* Key Metrics */}
								<MetricsDashboard title="Key Results" metrics={keyMetrics} columns={4} />
								...
								<div className="mt-8 flex flex-wrap gap-4">
									...
									{caseStudyData.documentationUrl && (
										<Button variant="outline" asChild>
											<Link
												href={caseStudyData.documentationUrl}
												target="_blank"
												rel="noopener noreferrer"
											>
							...
							<motion.section variants={itemVariants} id="problem-statement" className="mb-16">
								<h2 className={`mb-6 flex items-center gap-3 ${typeRole.sectionH2}`}>
									<AlertTriangle className="h-8 w-8 text-orange-500" />
									Problem Statement
								</h2>
								<div className="prose prose-lg max-w-none">
									<p className={`text-muted-foreground mb-6 ${typeRole.articleBody}`}>
										The SMB market was underserved by existing chatbot solutions, with most
										platforms either too complex for small businesses or lacking the multi-tenant
										capabilities needed for agencies serving multiple clients. We identified a
										significant gap in the market for a user-friendly, scalable chatbot platform
										that could serve both individual businesses and agencies managing multiple
										client accounts.
									</p>
									...
									<div className="my-8 grid grid-cols-1 gap-6 md:grid-cols-2">
										<Card>
											<CardHeader>
												<CardTitle as="h3" className={typeRole.cardTitle}>
													Primary Challenges
												</CardTitle>
											</CardHeader>
											<CardContent>
							...
							<motion.section variants={itemVariants} id="lessons-learned" className="mb-16">
								<h2 className={`mb-6 ${typeRole.sectionH2}`}>Lessons Learned</h2>

								<div className="grid grid-cols-1 gap-8 md:grid-cols-2">
									<Card>
										<CardHeader>
											<CardTitle as="h3" className={`text-green-600 ${typeRole.cardTitle}`}>
												What Worked Well
											</CardTitle>
										</CardHeader>
										<CardContent>
											<ul className="space-y-3">
												<li className="flex items-start gap-3">
													...
													<div>
														...
														<div className="text-muted-foreground text-sm">
															Provided clear value proposition for agencies
														</div>
													</div>
												</li>
												<li className="flex items-start gap-3">
													...
													<div>
														...
														<div className="text-muted-foreground text-sm">
															Reduced friction for SMB adoption
														</div>
													</div>
												</li>
												<li className="flex items-start gap-3">
													...
													<div>
														...
														<div className="text-muted-foreground text-sm">
															Differentiated us from rule-based competitors
														</div>
													</div>
												</li>
											</ul>
									...
									<Card>
										<CardHeader>
											<CardTitle as="h3" className={`text-orange-600 ${typeRole.cardTitle}`}>
												Challenges Overcome
											</CardTitle>
										</CardHeader>
										<CardContent>
											<ul className="space-y-3">
												<li className="flex items-start gap-3">
													...
													<div>
														...
														<div className="text-muted-foreground text-sm">
															Required careful planning for performance
														</div>
													</div>
												</li>
												<li className="flex items-start gap-3">
													...
													<div>
														<div className="font-semibold">Custom branding</div>
														<div className="text-muted-foreground text-sm">
															Needed flexible theming system
														</div>
													</div>
												</li>
												<li className="flex items-start gap-3">
													...
													<div>
														...
														<div className="text-muted-foreground text-sm">
															Demanded robust infrastructure planning
														</div>
													</div>
												</li>
											</ul>
							...
							<motion.section variants={itemVariants} id="next-steps" className="mb-16">
								<h2 className={`mb-6 ${typeRole.sectionH2}`}>Next Steps</h2>
								...
								<Card className="mt-12">
									<CardContent className="pt-6">
										<div className="text-center">
											<h3 className={`mb-2 ${typeRole.subsectionH3}`}>
