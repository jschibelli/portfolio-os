...
# Usage: .\scripts\automation\auto-configure-pr.ps1 -PRNumber <NUMBER> [-Status <STATUS>] [-Priority <PRIORITY>] [-Size <SIZE>] [-Estimate <ESTIMATE>] [-App <APP>] [-Area <AREA>] [-Assign <ASSIGNEE>] [-DryRun]
