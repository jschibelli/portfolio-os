# Detailed PowerShell script to audit project status assignments
# Usage: .\scripts\detailed-project-audit.ps1 [-DryRun]
...
function Main {
    Write-ColorOutput "=== Detailed Portfolio OS Project Status Audit ===" "Blue"
