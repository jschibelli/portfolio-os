# Comprehensive PowerShell script to audit all project items
# Usage: .\scripts\comprehensive-project-audit.ps1 [-DryRun]
...
function Main {
    Write-ColorOutput "=== Comprehensive Project Board Audit ===" "Blue"
    ...
    Write-ColorOutput "2. Issues waiting to be worked on → Backlog" "White"
    Write-ColorOutput "3. Issues being worked on → In progress" "White"
    Write-ColorOutput "4. Issues with PRs created → Ready" "White"
    Write-ColorOutput "5. Open PRs being reviewed → In progress" "White"
    Write-ColorOutput "6. Merged/Closed PRs → Done" "White"
    Write-ColorOutput ""
